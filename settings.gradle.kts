...
for (name in listOf("divinemc-api", "divinemc-server", "huntercore-network-common", "huntercore-network-bungee", "huntercore-network-velocity", "huntercore-plugins:hunter-tpa", "huntercore-plugins:hunter-auth", "huntercore-plugins:hunter-tools")) {
