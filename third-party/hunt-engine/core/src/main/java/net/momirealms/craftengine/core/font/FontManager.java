...
public interface FontManager extends Manageable {
    ...
    String BYPASS_BOOK = "huntengine.filter.bypass.book";
    String BYPASS_SIGN = "huntengine.filter.bypass.sign";
    String BYPASS_CHAT = "huntengine.filter.bypass.chat";
    String BYPASS_COMMAND = "huntengine.filter.bypass.command";
    String BYPASS_ANVIL = "huntengine.filter.bypass.anvil";
